...
- **Fletching Table**: arrow + torch → 4 torch arrows (requires [The Fletching Table](https://modrinth.com/mod/the-fletching-table))
...
- [The Fletching Table](https://modrinth.com/mod/the-fletching-table) is optional, adds a higher-yield recipe
